...
\paragraph{A note on zero-valued goods.}
...
\emph{any} good $g\in X_j$, including one valued at zero. We adopt the stronger
\EFX$_0$ notion and state all of our results for it; the encoding of
Section~\ref{sec:reduction} tests precisely this condition.
